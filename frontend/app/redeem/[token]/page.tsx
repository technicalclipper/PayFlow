    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
          ...
          <div className="fixed inset-0 pointer-events-none z-50 overflow-hidden">
            {Array.from({ length: 50 }).map((_, i) => (
              <motion.div
                ...
                style={{
                  backgroundColor: ["#4F8CFF", "#7C5CFF", "#22C55E", "#F59E0B", "#EF4444", "#ffffff"][
      ...
      >
        ...
        <div className="bg-[#0f1420]/90 backdrop-blur-2xl border border-white/[0.08] rounded-2xl overflow-hidden shadow-2xl shadow-black/50">
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <motion.div
                    ...
                    className="inline-flex items-center gap-1.5 mt-4 px-3 py-1.5 rounded-full bg-success/10 text-success text-xs font-medium"
                  >
                ...
                >
                  ...
                  <Button
                    ...
                    icon={
                      state !== "loading" ? <ArrowRight className="w-5 h-5" /> : undefined
                    }
                  >
                ...
                <motion.div
                  ...
                  className="mt-6 flex items-center justify-center gap-4 text-xs text-text-muted"
                >
              ...
              >
                ...
                >
                  ...
                  <p className="text-sm text-text-secondary mb-6">
                    {SALARY_AMOUNT.toLocaleString()} USDC has been sent to your wallet
                  </p>
                  ...
                  <div className="bg-white/[0.03] rounded-xl p-4 mb-6 space-y-3 text-left">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-semibold text-success">
                        {SALARY_AMOUNT.toLocaleString()} USDC
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
          ...
          {/* Footer */}
          <div className="px-6 py-3 border-t border-white/[0.05] text-center text-[11px] text-text-muted">
            Powered by Circle & PayFlow
          </div>
        </div>
      </motion.div>
    </div>

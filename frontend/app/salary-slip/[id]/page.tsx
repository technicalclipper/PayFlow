...
export default function SalarySlipPage({
  ...
  const payrollEmployee =
    mockPayrolls
      ...
      .find((pe) => pe.id === id) ?? mockPayrolls[0].employees[0];
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="text-center py-6">
              ...
              <div className="text-5xl sm:text-6xl font-bold tracking-tight">
                <AnimatedCounter
                  end={payrollEmployee.salaryAmount}
                  prefix=""
                  duration={1.8}
                />
              </div>
            ...
            <div className="bg-white/[0.03] rounded-xl p-4 mb-6 space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  {payrollEmployee.salaryAmount.toLocaleString()} USDC
                </span>
              </div>
              <div className="flex justify-between text-sm">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-xs text-text-muted">
                Scan to claim or click below
              </p>

              <Link href={`/redeem/${redeemToken}`} className="w-full">
                <Button size="lg" className="w-full" icon={<ExternalLink className="w-4 h-4" />}>
                  Claim Salary
                </Button>
              </Link>
            </div>
